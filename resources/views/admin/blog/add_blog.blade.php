    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title text-center mb-4">Add Blog</h4>
                 <form method="POST" id="submit" action="{{route('blog.create')}}" enctype="multipart/form-data">
                    @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea id="elm1" name="desc" aria-hidden="true">{{old('desc')}}</textarea>
                        @error('desc')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
