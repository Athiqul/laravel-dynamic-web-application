                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        <div class="section__title">
                            ...
                            <h2 class="title">{{$about->title??'Demo Title'}}</h2>
                        </div>
                        <div class="about__exp">
                            ...
                            <div class="about__exp__content">
                                <p>{{$about->exp??"Demo exprience or Achivement"}}</p>
                            </div>
                        </div>
                        <p class="desc">{{$about->short_desc??'Demo area this for short Description area'}}</p>
                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="about-tab">
                                {!!$about->long_desc??'Long Desciption Area'!!}
            ...
            <div class="row justify-content-center">
                <div class="col-xl-9 col-lg-11">
                    <div class="testimonial__wrap">
                        ...
                        <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 1380px;"><div class="testimonial__item slick-slide slick-current slick-active" style="width: 690px; position: relative; left: 0px; top: 0px; z-index: 999; opacity: 1;" tabindex="0" data-slick-index="0" aria-hidden="false">
                            ...
                            </div><div class="testimonial__item slick-slide" style="width: 690px; position: relative; left: -690px; top: 0px; z-index: 998; opacity: 0;" tabindex="-1" data-slick-index="1" aria-hidden="true">
                                <div class="testimonial__icon">
                                    <i class="fas fa-quote-left"></i>
                                </div>
                                <div class="testimonial__content">
                        ...
                        <div class="testimonial__arrow"><button class="slick-prev slick-arrow" style=""><i class="far fa-long-arrow-left"></i></button><button class="slick-next slick-arrow" style=""><i class="far fa-long-arrow-right"></i></button></div>
                    </div>
                </div>
            </div>
        </div>
