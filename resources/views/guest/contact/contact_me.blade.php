        ...
        <div class="container">
            <form action="{{route('contact.admin')}}" method="POST" class="contact__form">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="text" placeholder="Enter your Contact Number*" name="contact_number">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        ...
                        <div class="contact__info__content">
                            ...
                            <span>{{$contactInfo->street_address??'Bowery St, New York, <br> NY 10013,'}} {{$contactInfo->region??'USA'}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        ...
                        <div class="contact__info__content">
                            ...
                            <span>{{$contactInfo->contact_number??'+1255 - 568 - 6523'}}</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="contact__info">
                        ...
                        <div class="contact__info__content">
                            ...
                            <span>{{$contactInfo->contact_email??'email@example.com'}}</span>
