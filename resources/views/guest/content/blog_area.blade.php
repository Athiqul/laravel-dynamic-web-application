...
<section class="blog">
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-9">
                <div class="blog__post__item">
                    <div class="blog__post__thumb">
                        <a href="{{route('blog.details',$blog->id)}}"><img src="{{asset('uploads/blogs/'.$blog->image_link)}}" alt=""></a>
                        <div class="blog__post__tags">
                            
                            <a href="{{route('blog.details',$blog->id)}}">{{$blog->category}}</a>
                        </div>
                    </div>
        ...
        <div class="blog__button text-center">
            <a href="{{route('front.blogs')}}" class="btn">more blog</a>
        </div>
    </div>
</section>